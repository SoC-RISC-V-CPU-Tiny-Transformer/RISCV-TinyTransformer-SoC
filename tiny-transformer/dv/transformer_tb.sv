...
module Transformer_tb;
    ...
    initial begin
        ...
        $display("-> Computing Q, K, V... (Please wait)");
        ...
        check_sram("tb_data_v1/Q_sram3_gold.hex", 3, "Matrix Q (SRAM_3)");
        check_sram("tb_data_v1/K_sram0_gold.hex", 0, "Matrix K_T (SRAM_0)");
        check_sram("tb_data_v1/V_sram1_gold.hex", 1, "Matrix V (SRAM_1)");
        $display("----------------------------------------");
